...
uint8_t pCols[4][4] = { { 0x00, 0x00, 0x00, 0xC7 }, /*   0 -> 199 */
...
void touchgfx_init() {
	uint16_t dispWidth = 200;
	uint16_t dispHeight = 480;

	HAL &hal = touchgfx_generic_init<stm32F7_MyHAL>(dma, display, tc, dispWidth, dispHeight, (uint16_t*) 0, 0, 0);
